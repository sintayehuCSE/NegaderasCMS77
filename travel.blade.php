<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Travel agent Registration Page</title>
      ...
      <div class="card-body register-card-body">
        ...
        <form method="POST" action="travel" >
            ...
            <div class="input-group mb-3">
                ...
                placeholder="travel agency" name="name" value="{{ old('name')}}">
            ...
            <div class="input-group mb-3">
                <input type="number" class="form-control" placeholder="No. of cars" name="number" value="{{ old('number')}}">
                <div class="input-group-append">
                    <div class="input-group-text">
                        <span class="fas fa-envelope"></span>
                    </div>
